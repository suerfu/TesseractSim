...
void GetGammaTh232(const char* ext = ".root"){

  const char* inDir = "/Volumes/GoogleDrive/My Drive/GraduateWork/TESSERACT/Tesseract_sim_output/geom2_helium/GammaTh232/";
  ...
  TFile* f = TFile::Open("/Volumes/GoogleDrive/My Drive/GraduateWork/TESSERACT/Tesseract_sim_output/geom2_helium/ProcessedFiles/GammaTh232_processed.root");
  ...
  double specific_activity_Th232=308.06017305599997;// perSec per m^2 due to 1 Bq/kg from Suerfu
